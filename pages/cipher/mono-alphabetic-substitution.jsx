                ...
                {key && (
                  <div className="flex gap-2 items-center w-full">
                    ...
                    <input
                      ...
                      required={true}
                      className="block w-full rounded-md uppercase dark:bg-gray-800 dark:border-gray-700 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    />
                  </div>
                )}
